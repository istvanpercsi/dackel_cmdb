...
public class PropertiesController {
    ...
    ResponseEntity<ListOfSimplePropertyResponse> getProperties(
        ...
        return new ResponseEntity<>(ListOfSimplePropertyResponse.builder().properties(List.of(SimplePropertyResponse.builder().id(UUID.randomUUID()).name("blabla").build())).build(),HttpStatus.NOT_IMPLEMENTED);
